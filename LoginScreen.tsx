    ...
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
        <View style={styles.content}>
          <Text style={styles.title}>Cyclaa Mechanic</Text>
          <Text style={styles.subtitle}>Sign in to see your booking requests.</Text>
...
const styles = StyleSheet.create({
  ...
  error: { ...TYPOGRAPHY.bodySm, color: COLORS.semantic.error, marginTop: SPACING.md, marginBottom: SPACING.md },
});
