  ...
  return (
    <Card style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        {mechanic.hourlyRate != null && <Text style={styles.rate}>${mechanic.hourlyRate}/hr</Text>}
      </View>
      <Text style={styles.meta}>
        ★ {mechanic.rating.toFixed(1)} ({mechanic.reviewCount})
        {mechanic.distanceMiles != null ? ` · ${mechanic.distanceMiles} mi` : ''}
        {mechanic.specialties.length ? ` · ${mechanic.specialties.join(', ')}` : ''}
      </Text>
      <Button
